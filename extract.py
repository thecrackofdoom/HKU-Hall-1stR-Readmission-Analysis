...
if __name__ == "__main__":
    ...
    if conn:
        ...
        added = ["SHC.pdf", "CSC.pdf", "LCC.pdf", "NC.pdf", "DHC.pdf", "1.pdf", "2.pdf", "KCC.pdf","LHTH.pdf","LHH.pdf","LSK.pdf","MH.pdf","RCLee.pdf","Ricci.pdf","SKYLee.pdf", "SJC.pdf","Starr.pdf","SCSH.pdf", "Swire.pdf", "UH.pdf"]
        adding = ["WL.pdf"]
